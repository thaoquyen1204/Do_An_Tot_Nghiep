...
class NhanVienGridScreen extends StatefulWidget {
  ...
  final String? photoURL;
     NhanVienGridScreen({required this.userEmail, required this.displayName, this.photoURL,});  // Thêm tham số cho năm
          ...
          if (constraints.maxWidth >= 600) {
            return Row(
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      TrangChuBM(userEmail: widget.userEmail ?? '',
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    ElevatedButton(
                                                      onPressed: () {
                                                         print('Giá trị displayName: ${widget.displayName}');
                                                        final year = int.tryParse(_yearController.text) ??
                                                            DateTime.now().year;
                                                        Navigator.push(
                                                          context,
