 ...
 Future<void> _pickImage() async {
  ...
  if (_sdtController.text.length != 10) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Số điện thoại phải có đủ 10 số.')),
    );
  ...
  if (!_emailController.text.endsWith('@gmail.com')) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Email phải có định dạng @gmail.com.')),
    );
    ...
    if (nguoidung == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Không tìm thấy nhân viên.')),
      );
      return;
    }
  ...
  if (_image != null) {
    ...
    nguoidung.tenTaiKhoan =_tenTaiKhoanController.text; // Cập nhật tên tài khoản
    ...
    try {
      ...
      _showSuccessDialog(context,widget.userEmail,widget.displayName,widget.photoURL);
    } catch (error) {
      // Xử lý lỗi nếu có
      ScaffoldMessenger.of(context).showSnackBar(
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) =>  XemTTNguoidung(userEmail: userEmail,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            child: Text('Chọn ảnh từ thiết bị'),
                          ),
