...
class DanhsachCNDG extends StatefulWidget {
    final String userEmail;
  final String displayName;
  final String? photoURL;
     DanhsachCNDG({required this.userEmail, required this.displayName,required this.photoURL,});  // Thêm tham số cho năm

  @override
  _NhanVienGridScreenState createState() => _NhanVienGridScreenState();
}

class _NhanVienGridScreenState extends State<DanhsachCNDG> {
  ...
  void initState() {
    super.initState();
    _fetchNhanViens();
    _yearController.text = currentYear.toString(); // Gán năm hiện tại vào TextField
  }
          ...
          if (constraints.maxWidth >= 600) {
            return Row(
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      TrangChuDG(userEmail: widget.userEmail ?? '',
                displayName: widget. displayName ?? '', photoURL:  widget.photoURL ?? '',), // Điều hướng đến chi tiết KPI
                ),
              );
                        },
                      ),
                            ...
                            ElevatedButton(
                              onPressed: () {
                                                        ...
                                                        Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                            builder: (context) => TrucquanDG(userEmail:widget.userEmail, displayName: widget.displayName,photoURL: widget.photoURL,
                                                                ),
                                                          ),
                                                        );
                                                      },
                                      ...
                                      builder: (context, constraints) {
                                        ...
                                        return GridView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            String currentStatus = statusMap[nhanVien.maNv] ?? 'Chưa kiểm tra';
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      ...
                                                      style: TextStyle(
                                                        color: currentStatus == 'Chưa đánh giá'
                                                            ? Colors.green
                                                            : currentStatus == 'Đã được đánh giá'
                                                            ?Colors.purple
                                                            : currentStatus == 'Chưa đủ điều kiện'
                                                                ? Colors.red
                                                                : Colors.orange,
                                                    ...
                                                    ElevatedButton(
                                                      onPressed: () {
                                                        ...
                                                        Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                            builder: (context) => DanhgiaCN(
                                                                maNV: nhanVien.maNv, year: year, userEmail: widget.userEmail, displayName: widget.displayName,photoURL: widget.photoURL,),
                                                          ),
                                                        );
                                                      },
    ...
    Flexible(
      ...
      onPressed: () {
                                                        ...
                                                        Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                            builder: (context) => Trucquan(userEmail:widget.userEmail, displayName: widget.displayName,photoURL: widget.photoURL,
                                                                ),
                                                          ),
                                                        );
                                                      },
