...
import 'package:flutter_login_api/screens/dashboard/components/storage_detailsTP.dart';
            ...
            Row(
              ...
              photoURL: photoURL,),
                      ...
                      if (Responsive.isMobile(context))
                        SizedBox(height: defaultPadding),
                      if (Responsive.isMobile(context)) StorageDetailsP(userEmail: userEmail,
                    displayName: displayName,
                    photoURL: photoURL!,),
                    ],
                  ),
                ...
                if (!Responsive.isMobile(context))
                  Expanded(
                    flex: 2,
                    child: StorageDetailsP(userEmail: userEmail,
                    displayName: displayName,
                    photoURL: photoURL!,),
                  ),
              ],
