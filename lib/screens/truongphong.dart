...
class TruongPhong extends StatefulWidget {
  final String userEmail;
  final String displayName;
  final String? photoURL;
  const TruongPhong({required this.userEmail, required this.displayName, this.photoURL});

  @override
  _TruongPhongState createState() => _TruongPhongState();
}

class _TruongPhongState extends State<TruongPhong> {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 8.0,
              children: [
                _buildCategoryButton(Icons.museum, 'Museums'),
                _buildCategoryButton(Icons.terrain, 'Mountains'),
                _buildCategoryButton(Icons.beach_access, 'Beaches'),
