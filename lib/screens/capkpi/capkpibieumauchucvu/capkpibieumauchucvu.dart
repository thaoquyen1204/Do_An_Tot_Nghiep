...
class _CapKpiBMCVScreenState extends State<CapKPIBMCV>
                                  ...
                                  child: Container(
                                    ...
                                    child: DropdownButton<String>(
                                      ...
                                      hint: const Text(
                                        ...
                                        style: TextStyle(
                                          color: Colors
                                              .black, // Đổi màu chữ của hint thành đen
                                        ),
                                      ),
                                      value:
  ...
  Future<void> _handleSave1() async {
    ...
    try {
      ...
      maphieukpi = (await usuarioProvider.GetChiTietKPIKKpByMCCDvaNam(
          selectedmachucdanh.toString(), currentYear))!;
      // Gọi hàm lưu KPI
      if (maphieukpi != null) {
        await deletechitietKPIKP(
            maphieukpi!); // Chỉ thực hiện nếu maphieukpi khác null
      }
      await saveChitietkpikhoaphong(
...
// Hàm để lưu chỉnh sửa
  Future<void> _LayMaPhieu() async {
    ...
    print(
        'Chi tiết KPI cá nhân: ${Provider.of<Usuario_provider2>(context, listen: false).chitietkpikhoaphong}');
